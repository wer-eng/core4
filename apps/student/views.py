...
class StudentListView(ListView):
    ...
    def get_queryset(self):
        queryset = {"students": StudentList.objects.prefetch_related('students').all()}
        queryset = {"studentlist": StudentList.objects.select_related('className','session').prefetch_related('students').all()}
